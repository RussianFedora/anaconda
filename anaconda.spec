...
Patch100: anaconda-29.24.2-hardcode-repo.patch
# Read name from rfremix-release
Patch101: anaconda-28.22.10-read-from-rfremix-release.patch
# Some fixes for RFRemix to be not hidden
Patch102: anaconda-26.21.1-rfremix-installclasses-fix.patch
# use rfremix env
Patch103: anaconda-29.24.2-rfremix-installclasses.patch
